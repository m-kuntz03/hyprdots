...
function synctex() {
    ...
    if (!vscode.window.activeTextEditor || !lw_1.lw.file.hasLaTeXLangId(vscode.window.activeTextEditor.document.languageId)) {
...
function addTexRoot() {
    ...
    if (!vscode.window.activeTextEditor || !lw_1.lw.file.hasLaTeXLangId(vscode.window.activeTextEditor.document.languageId) || !lw_1.lw.file.hasLaTeXClassPackageLangId(vscode.window.activeTextEditor.document.languageId)) {
