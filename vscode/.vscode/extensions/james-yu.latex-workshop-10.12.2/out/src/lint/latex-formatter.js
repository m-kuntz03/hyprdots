...
const math_fixer_1 = require("../extras/math-fixer");
...
class FormattingProvider {
    ...
    async provideDocumentFormattingEdits(document, _options, _token) {
        ...
        const quoteEdits = (0, quote_fixer_1.fixQuotes)(document, undefined);
        edits.push(...quoteEdits);
        const mathEdits = (0, math_fixer_1.fixMath)(document, undefined);
    ...
    async provideDocumentRangeFormattingEdits(document, range, _options, _token) {
        ...
        const quoteEdits = (0, quote_fixer_1.fixQuotes)(document, range);
        edits.push(...quoteEdits);
        const mathEdits = (0, math_fixer_1.fixMath)(document, range);
        edits.push(...mathEdits);
        return edits;
    }
}
